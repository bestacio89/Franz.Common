...
/// <summary>
/// Wrapper around Confluent.Kafka IConsumer for simplified usage.
/// </summary>
public class KafkaConsumer(IConsumer<string, string> consumer) : IConsumer<string, string>
{
  ...
  public List<TopicPartitionOffset> Committed(IEnumerable<TopicPartition> partitions, TimeSpan timeout)
      => _consumer.Committed(partitions, timeout).ToList();
