...
- **Native OpenAPI Integration** *(since 2.2.11)*:
...
| `Franz.Common.Business` | 2.2.11 |
| `Franz.Common.Reflection` | 2.2.11 |

> **Removed since v2.2.11:**
