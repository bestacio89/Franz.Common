...
- **Native OpenAPI Integration** *(since 2.2.10)*:
...
| `Franz.Common.Business` | 2.2.10 |
| `Franz.Common.Reflection` | 2.2.10 |

> **Removed since v2.2.10:**
