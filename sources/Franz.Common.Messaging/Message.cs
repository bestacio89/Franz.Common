...
public class Message : INotification
{
  ...
  public Message(string? body, IEnumerable<KeyValuePair<string, StringValues>> headers) : this()
  {
    Body = body;
    Headers = new MessageHeaders(headers);
  }

  public Message(string? body, IEnumerable<KeyValuePair<string, string[]>> headers) : this()
  {
    Body = body;
    Headers = new MessageHeaders(
